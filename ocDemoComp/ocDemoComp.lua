...
• Hint from the organizers: OpenComputers has highly limited audio capabilities, but Computronics provides a
  Beep Card, Noise Card, Sound Card and Tape Drive!
• If you use the Tape Drive for audio, generating your music inside OpenComputers is considered good form
...
(floppy disk or hard drive). Please note that floppy disk contributions are encouraged as they’re
cooler - and if we get enough of them, we might make a separate category for them!

In the EEPROM category, your demo must run fully off an OpenComputers EEPROM card and load no external data.

In the Game category, we’re going to do our best to play your game - please provide some sort of
documentation on how to play the game.

In the Tool category, you can show non-game applications for OpenComputers - though this will probably
involve you either providing some sort of demonstration or showing it off yourself (in which case,
